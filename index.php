...
<html lang="zxx">
  <head>
    ...
    <link rel="stylesheet" href="css/bootstrap1.min.css" /> <?php include 'links.php'?>
  </head>
  <body class="crm_body_bg"> <?php include 'header.php'?> <section class="main_content dashboard_part large_header_bg">
              ...
              <div class="sales_unit_footer d-flex justify-content-between">
                <div class="single_sales">
                  ...
                  <p class="d-flex align-items-center">
                    ...
                    <span> 14.5%</span> Up From Last Month
                  </p>
                </div>
              ...
              <div class="white_card card_height_100  mb_20">
                ...
                <div class="white_card_body">
                  ...
                  <div class="load_more_button text-center mt_30">
                    <a class="theme_text_btn d-flex align-items-center justify-content-center" href="#">Load more <i class="ti-angle-down f_s_12 ms-2"></i>
                    </a>
                  </div>
                </div>
              </div>
                  ...
                  <div class="monthly_plan_wraper">
                    ...
                    <div class="single_plan d-flex align-items-start justify-content-between">
                      <div>
                        ...
                        <p class="f_s_13 f_w_700">Netflix and other bills in this month.</p>
                      </div>
                      <span class="color_gray2 f_s_16 f_w_700">$25</span>
                    </div>
                      ...
                      <tbody>
                          ...
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/1.png" alt>
                              </div>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/2.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/3.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/4.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/5.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/6.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Customer</span>
                            </div>
                          </td>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_1.png" alt>
                              </div>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_2.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_3.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_4.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_5.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                            </div>
                          </td>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_34 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_6.png" alt>
                              </div>
                              <span class="f_s_14 f_w_400 color_text_1">Product 1</span>
                            </div>
                          </td>
                    ...
                    <table class="table lms_table_active2 p-0">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_62 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_big.png" alt>
                              </div>
                          ...
                          <td class="f_s_14 f_w_400 text-end">
                            <a href="#" class="badge_btn_1">354 sold</a>
                          </td>
                        </tr>
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_62 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_big_1.png" alt>
                              </div>
                        ...
                        <tr>
                          <td>
                            <div class="customer d-flex align-items-center">
                              <div class="thumb_62 mr_15 mt-0">
                                <img class="img-fluid radius_50" src="img/customers/pro_big_2.png" alt>
                              </div>
